...
Floe uses the following third-party components. Their licenses are compatible
with distributing Floe as open-source software, provided their notices and
license terms are retained.

| Component | Version | License |
|---|---:|---|
| [pkg/sftp](https://github.com/pkg/sftp) | 1.13.7 | BSD-2-Clause |
| [jlaffaye/ftp](https://github.com/jlaffaye/ftp) | 0.2.0 | ISC |
| [golang.org/x/crypto](https://pkg.go.dev/golang.org/x/crypto) | 0.36.0 | BSD-3-Clause |
| [golang.org/x/sys](https://pkg.go.dev/golang.org/x/sys) | 0.31.0 | BSD-3-Clause |
| [hashicorp/go-multierror](https://github.com/hashicorp/go-multierror) | 1.1.1 | MPL-2.0 |
